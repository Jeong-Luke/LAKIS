...
**[Download LAKIS Studio v7.3.2 for Windows](https://github.com/Jeong-Luke/LAKIS/releases/download/v7.3.2/LAKIS_Setup.exe)**

Run `LAKIS_Setup.exe` to install or repair LAKIS. You can also view the
[v7.3.2 release notes and individual files](https://github.com/Jeong-Luke/LAKIS/releases/tag/v7.3.2).

## Stable baseline

This repository contains the stable LAKIS distribution line. The current prepared baseline is `v7.3.2`. Earlier development packages and workflows are maintained separately and are not distributed to new users.
