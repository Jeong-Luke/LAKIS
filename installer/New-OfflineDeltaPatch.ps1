param(
    [string]$FromVersion = "7.3.5",
    [string]$Version = "7.3.6",
    [string]$OldManifest = "",
    [string]$NewManifest = "",
...
[System.IO.File]::WriteAllText((Join-Path $output "INSTALL_LAKIS_7.3.6_RC.cmd"), $launcher, [System.Text.UTF8Encoding]::new($false))
[ordered]@{
